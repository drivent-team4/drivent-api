      ...
      data: [
        {
          ...
          capacity: 30,
          startAt: dayjs().year(2023).month(5).day(27).hour(9).toDate(),
          endAt: dayjs().year(2023).month(5).day(27).hour(10).toDate(),
        },
        {
          name: 'Tecnologia Blockchain',
          auditoryId: Number(workshop.id),
          capacity: 30,
          startAt: dayjs().year(2023).month(5).day(27).hour(13).toDate(),
          endAt: dayjs().year(2023).month(5).day(27).hour(14).toDate(),
        },
        {
          name: 'Ciência de Dados para Iniciantes',
          auditoryId: Number(workshop.id),
          capacity: 30,
          startAt: dayjs().year(2023).month(5).day(28).hour(10).toDate(),
          endAt: dayjs().year(2023).month(5).day(28).hour(11).toDate(),
        },
        {
        ...
        },
        {
          ...
          auditoryId: Number(lateral.id),
          capacity: 20,
          startAt: dayjs().year(2023).month(5).day(28).hour(13).toDate(),
          endAt: dayjs().year(2023).month(5).day(28).hour(14).toDate(),
        },
        {
